...
namespace InvoicesManagerWebApp.Migrations
{
    ...
    [Migration("20231211091639_AddedCompanyInformationToUser")]
    partial class AddedCompanyInformationToUser
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InvoicesManagerWebApp.Models.Customer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("InvoicesManagerWebApp.Models.Invoice", b =>
                {
                    b.HasOne("InvoicesManagerWebApp.Models.Customer", "Customer")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InvoicesManagerWebApp.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
